...
- [ ] **Step 1: Fix Cargo.toml edition and add scraping dependency**
...
- [ ] **Step 2: Create `src/core/types.rs` with all data types**
...
- [ ] **Step 4: Create placeholder `src/core/catalog.rs`, `src/core/swagger.rs`, `src/core/caller.rs`**
...
- [ ] **Step 5: Create `src/config/paths.rs`**
...
- [ ] **Step 6: Rewrite `src/config/mod.rs`**
...
- [ ] **Step 7: Create `src/cli/mod.rs` with empty sub-modules**
...
- [ ] **Step 8: Rewrite `src/main.rs` with new module structure**
...
- [ ] **Step 9: Delete old module stubs and verify build**
...
- [ ] **Step 3: Make modules public in `src/main.rs` for test access**
...
- [ ] **Step 1: Write failing test for meta API response parsing**
...
- [ ] **Step 3: Implement `parse_meta_response` in `src/core/catalog.rs`**
...
- [ ] **Step 3: Implement `search_catalog` in `src/core/catalog.rs`**
...
- [ ] **Step 5: Implement `cli/search.rs` and `cli/update.rs`**
...
- [ ] **Step 1: Write failing test for Swagger spec parsing**
...
- [ ] **Step 3: Implement `parse_swagger` in `src/core/swagger.rs`**
...
- [ ] **Step 3: Implement caller in `src/core/caller.rs`**
...
- [ ] **Step 1: Implement MCP JSON-RPC server in `src/mcp/server.rs`**
...
- [ ] **Step 2: Implement tool handlers in `src/mcp/tools.rs`**
...
- [ ] **Step 4: Update MCP command in `src/main.rs`**
...
- [ ] **Step 1: Add bundled catalog support**
...
- [ ] **Step 3: Update README.md with usage examples and MCP setup**
