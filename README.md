...
| 특징 | 설명 |
|------|------|
| **자동 카탈로그** | 공공데이터포털 메타 API로 전체 API 목록을 자동 수집. 새 API도 코드 변경 없이 지원 |
...
│   ├── core/            # 핵심 로직 (카탈로그, Swagger 파싱, API 호출)
...
| [MVP 구현 플랜](docs/superpowers/plans/2026-03-31-phase1-mvp.md) | 태스크별 상세 구현 단계 (TDD 기반) |
